Scripts to programmatically connect to Anaplan's API, retrieve parameters created/stored in Anaplan, and import new parameters/data into an Anaplan model.
